...
function askClaude(message, userId) {
  return new Promise((resolve, reject) => {
    const systemPrompt = `Тебя зовут Аида. Ты секретарь клиники пластической хирургии доктора Казиловой Муминат Ахмедовны в Махачкале.
...
2. Описывай что это за процедура и для кого она подходит — это информация, а не медицинский совет
3. Стоимость не называй точно — говори "цена определяется индивидуально на консультации"
4. Для записи всегда направляй: WhatsApp +7 (999) 516-03-89 или Telegram @kazilova
5. Если вопрос не связан с услугами клиники — вежливо переведи разговор на запись к доктору
6. Пиши на русском языке, простым текстом, без звёздочек и решёток`;
...
bot.start((ctx) => {
  ctx.reply(
    'Здравствуйте! 👋\n\nМеня зовут Аида, я секретарь клиники доктора Казиловой Муминат Ахмедовны.\n\n' +
